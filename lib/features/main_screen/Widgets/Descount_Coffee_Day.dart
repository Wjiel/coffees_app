...
class DiscountCoffeeDay extends StatefulWidget {
  const DiscountCoffeeDay({super.key});

  @override
  State<DiscountCoffeeDay> createState() => _DiscountCoffeeDayState();
}

final myStream _streamCoffeeDay = myStream();

class _DiscountCoffeeDayState extends State<DiscountCoffeeDay> {
  void _getImageCoffeesDay(
